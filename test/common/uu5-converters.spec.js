...
describe("Unknown tags", () => {
  uu5ToMdTest(
    "Unknown tag without MD content",
    "<UUS.Unknown>Some Text</UUS.Unknown>",
    "<UUS.Unknown>Some Text</UUS.Unknown>"
  );
  uu5ToMdTest(
    "Unknown tag with known UU5 -> MD content (simple)",
    "<UUS.Unknown>Some <UU5.Bricks.Strong>Text</UU5.Bricks.Strong></UUS.Unknown>",
    "<UUS.Unknown>Some <UU5.Bricks.Strong>Text</UU5.Bricks.Strong></UUS.Unknown>"
  );
  uu5ToMdTest(
    "Unknown tag with known UU5 -> MD content (complex)",
    [
      "<UUS.Unknown>",
  ...
  uu5ToMdTest(
    "Unknown tag with entities",
    "<UUS.Unknown attr1=\"'><&\" attr2='\"><&'>Some Text</UUS.Unknown>",
    "<UUS.Unknown attr1=\"'><&\" attr2='\"><&'>Some Text</UUS.Unknown>"
  );
  uu5ToMdTest(
    "Unknown tag with uu5json",
  ...
  uu5ToMdTest(
    "Known tag with unknown attribute without value",
...
<UU5.Bricks.Header level="2">
  ...
  uu5ToMdTest(
    "Paragraph with emphasis in pretty format",
    `
<UU5.Bricks.P>
  Some
  <UU5.Bricks.Strong>
  ...
  uu5ToMdTest(
    "Header with following unknown element",
    `
